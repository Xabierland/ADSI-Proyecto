...
class TestRS(BaseTestClass):
    ...
    def test_F6P3(self):
        ...
        - Usuario logeado
        - Usuario no tiene prestamos
        - Usuario tiene amigos
            - El amigo no tiene prestamos
        """
        pass
    ...
    def test_F6P4(self):
        ...
        - Usuario no tiene prestamos
        - Usuario tiene amigos
            - El amigo tiene prestamos
                - El prestamo no comparte tema con otro libro
        """
    ...
    def test_F6P5(self):
        ...
        - Usuario tiene amigos
            - El amigo tiene prestamos
                - El prestamo comparte tema con otro libro
        """

    def test_F6PX(self):
        """Test para comprobar que:
        - Usuario logeado
        - Usuario tiene prestamos
            - El prestamo comparte tema con otro libro
        - Usuario no tiene amigos
        """
        # Inicia sesion
