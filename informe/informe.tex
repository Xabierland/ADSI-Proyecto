...
\begin{document}
    ...
    \chapter{Diagramas de comunicación}
        ...
        \section{Red de amigos}
            ...
            \clearpage
            \begin{enumerate}
                \item[1] El usuario selecciona el perfil en el menú principal.
                \item[2] new UI_Perfil(user\_id).
                \item[3] getAmigos(user\_id):JSON\_Usuarios
                \begin{enumerate}
                    \item[3.1] listaAmigos=getFriendsFriends(user\_id):JSON\_Usuarios
                    \begin{enumerate}
                        \item[3.1.1] execSQL(''
                        execSQL(''
                        ...
                        \end{enumerate}
                        \item[3.1.2] next()
                        \item[3.1.3] getString('nombre'):String
                    \end{enumerate}
                    \end{enumerate}
                \item[4] Editar perfil
                \begin{enumerate}
                    \item[4.1] new Fig. 3.2.3.5.
                    \begin{enumerate}
                        \item[4.1.1] El usuario introduce los datos del usuario
                        \begin{enumerate}
                            \item[4.1.1.1] modificarDatos(id_user)
                        \end{enumerate}
                        \begin{enumerate}
                            \item[4.1.1.1.1] modificarDatos(id_user)
                        \end{enumerate}
                        \begin{enumerate}
                            \item[4.1.1.1.1] execSQL(UPDATE User SET nombre = \%Nuevo nombre\%,\ apellidos = \%Nuevos apellidos\%, fecha\_nacimiento = \%Nueva fecha nacimiento\%, passwd = \%Nueva contraseña\% WHERE id\_user = id\_user)
                        \end{enumerate}
                        \end{enumerate}
                    \end{enumerate}
                    \end{enumerate}
                \end{enumerate}
                \item[5] Consultar reseñas
                \begin{enumerate}
                    \item[5.1] new Fig. (id_user)
                    \begin{enumerate}
                        \item[5.1.1] getReseñas(id_user) : JSON_Reseñas
                        \begin{enumerate}
                            \item[5.1.1.1] getReseña(id_user) : Reseña
                        \end{enumerate}
                        \begin{enumerate}
                            \item[5.1.1.1.1] execSQL((SELECT id libro FROM Libros WHERE                                     Libro.id libro= %id libro %):
                            ResultadoSQL)
                        \end{enumerate}
                        \begin{enumerate}
                            \item[5.1.1.1.1.1] new ResultadoSQL
                        \end{enumerate}
                        \item[5.1.1.1.2] next()
                        \item[5.1.1.1.3] getTitulo('idLibro'):String
                        \item[5.1.1.1.4] getReseña('idLibro'):String
                        \end{enumerate}
                    \end{enumerate}
                    \end{enumerate}
                \end{enumerate}
                \item[6] Consultar reservas
                \begin{enumerate}
                    \item[6.1] new Fig. (id_user)
                    \begin{enumerate}
                        \item[6.1.1] getUserPrestamos(id_user) : JSON_Reservas
                        \begin{enumerate}
                            \item[6.1.1.1] getUserPrestamo(id_user) : JSON_Reservas
                        \end{enumerate}
                        \begin{enumerate}
                            \item[6.1.1.1.1] execSQL((SELECT id_copia, fechaPrestamo FROM Prestamo WHERE id_user= %id_user%):
                            ResultadoSQL)
                        \end{enumerate}
                        \begin{enumerate}
                            \item[6.1.1.1.1.1] new ResultadoSQL
                        \end{enumerate}
                        \item[6.1.1.1.2] next()
                        \item[6.1.1.1.3] getIdCopia('idLibro'):int
                        \item[6.1.1.1.4] getfechaPrestamo('idLibro'):Date
                        \end{enumerate}
                    \end{enumerate}
                    \end{enumerate}
                \end{enumerate}
                \item[7] Añadir amigo
                \begin{enumerate}
                    \item[7.1] new Fig.3233 (id_user)
                    \begin{enumerate}
                        \item[7.1.1] añadirAmigo(user_id)
                        \begin{enumerate}
                            \item[7.1.1.1] execSQL((INSERT INTO Amigo VALUES user_ID = %user_id%)):
                            ResultadoSQL)
                        \end{enumerate}
                                            \end{enumerate}
                   
                \end{enumerate}
                \item[7] Eliminar amigo
                \begin{enumerate}
                    \item[7.1] new Fig.3233 (id_user)
                    \begin{enumerate}
                        \item[7.1.1] añadirAmigo(user_id)
                        \begin{enumerate}
                            \item[7.1.1.1] execSQL((DELETE INTO Amigo VALUES user_ID = %user_id%)):
                            ResultadoSQL)
                        \end{enumerate}
                                            \end{enumerate}
                \end{enumerate}
