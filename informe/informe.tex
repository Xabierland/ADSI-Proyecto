...
\begin{document}
    ...
    \chapter{Changelog}
        ...
        \section{Versión 4 (2023-11-15)}
            ...
            \end{itemize}
        \section{Versión 5 (2024-01-08)}
            \begin{itemize}
                \item Añadido diagrama de secuencia.
                \item Añadido conclusiones.
                \item Correcciones varias.
            \end{itemize}
                ...
                \subsubsection*{Gestión de usuarios}
                    \begin{center}
                        \begin{longtable}{|p{\linewidth}|}
                            ...
                            \begin{figure}[H]
                                \centering
                                \includegraphics[width=0.8\textwidth]{./img/grafico/FotoAdminPrincipal.png}
                                \\Figura 3.2.4.1.2: Interfaz del menú de administrador.
                            \end{figure}\\
                            \begin{figure}[H]
                                \centering
                                \includegraphics[width=0.8\textwidth]{./img/grafico/FotoGestorUsuarios.png}
                                \\Figura 3.2.4.1.3: Interfaz del menu de gestión de usuarios.
                            \end{figure}\\
                            \begin{figure}[H]
                                \centering
                                \includegraphics[width=0.8\textwidth]{./img/grafico/FotoCrearUsuario.png}
                                \\Figura 3.2.4.1.4: Interfaz para añadir un usuario.
                            \end{figure}\\
                            \begin{figure}[H]
                                \centering
                                \includegraphics[width=0.8\textwidth]{./img/grafico/errorAñadirUsuarios.png}
                                \\Figura 3.2.4.1.5: Interfaz de error al añadir un usuario.
                            \end{figure}\\
                            \begin{figure}[H]
                                \centering
                                \includegraphics[width=0.8\textwidth]{./img/grafico/FotoBorrarUsuario.png}
                                \\Figura 3.2.4.1.6: Interfaz para borrar un usuario.
                            \end{figure}\\
                            \begin{figure}[H]
                                \centering
                                \includegraphics[width=0.8\textwidth]{./img/grafico/ErrorBorrarUsuarios.png}
                ...
                \subsubsection*{Gestión de libros}
                    \begin{center}
                        \begin{longtable}{|p{\linewidth}|}
                            ...
                            \begin{figure}[H]
                                \centering
                                \includegraphics[width=0.8\textwidth]{./img/grafico/FotoGestorLibros.png}
                                \\Figura 3.2.4.2.3: Interfaz del menu de gestión de libros.
                            \end{figure}\\
                            \begin{figure}[H]
                                \centering
                                \includegraphics[width=0.8\textwidth]{./img/grafico/FotoAñadirLibro.png}
                                \\Figura 3.2.4.2.4: Interfaz para añadir un libro.
                            \end{figure}\\
                            \begin{figure}[H]
                                \centering
                                \includegraphics[width=0.8\textwidth]{./img/grafico/ErrorAñadirLibro.png}
                                \\Figura 3.2.4.2.5: Interfaz de error al añadir un libro.
                            \end{figure}\\
                            \begin{figure}[H]
                                \centering
                                \includegraphics[width=0.8\textwidth]{./img/grafico/FotoBorrarLibro.png}
                                \\Figura 3.2.4.2.6: Interfaz para borrar un libro.
                            \end{figure}\\
                            \begin{figure}[H]
                                \centering
                                \includegraphics[width=0.8\textwidth]{./img/grafico/ErrorBorrarLibro.png}
            ...
            \subsection{Recomendaciones de amigos}
                \begin{center}
                    \begin{longtable}{|p{\linewidth}|}
                        ...
                        \begin{figure}[H]
                            \centering
                                \includegraphics[width=0.8\textwidth]{./img/grafico/PerfilconRecomendaciondeAmigos.jpeg}
    ...
    \chapter{Plan de Pruebas}
        ...
        \section{Administrador}
            \begin{center}
                ...
                \begin{longtable}{|m{1.5cm}|m{2cm}|m{2cm}|m{2cm}|m{2cm}|}
                    \hline
        ...
        \section{Recomendaciones de amigos}
            \begin{center}
                ...
                \begin{longtable}{|m{1.5cm}|m{2cm}|m{2cm}|m{2cm}|m{2cm}|}
                    ...
                    \hline
                    F7P3.1 & Ver perfil con sesion y amigos pero sin libros alquilados previamente/acutlamente y tus amigos no tienen otros amigos & Muestra el perfil sin recomendaciones & Muestra el perfil sin recomendaciones & Funciona \\
                    \hline
                    F7P4 & Ver perfil con sesion y libros alquilados previamente/actualmente pero sin amigos & Muestra las recomendaciones en base a los libros aliquilados previamente/actualmente & Muestra las recomendaciones en base a los libros aliquilados previamente/actualmente & Funciona \\
                    \hline
                    F7P4.1 & Ver perfil con sesion y libros alquilados perviamente/actualmente pero sin amigos y el libro es el unico de su tema & Muestra el perfil sin recomendaciones & Muestra el perfil sin recomendaciones & Funciona \\
                    \hline
    ...
    \chapter{Diagramas de comunicación}
        \section{Gestión de reservas}
            ...
            \begin{figure}[H]
                \centering
                \includegraphics[width=1.0\textwidth]{img/comunicacion/reservas.PNG}
                \caption{Diagrama de comunicación de la gestión de reservas}
            \end{figure}
            \begin{enumerate}
                \item[1] Selecciona un libro y pulsa el botón Reservar.
                \item[2] reservarLibro(id\_libro, id\_user)
                \begin{enumerate}
                    \item[2.1] laCopia=buscarCopiaLibro(id\_libro)
                    \begin{enumerate}
                        \item[2.1.1] execSQL(SELECT id\_copia FROM CopiaLibro WHERE id\_libro = \%id\_libro\% AND Libre=1) : ResultadoSQL
                        \begin{enumerate}
                            \item[2.1.1.1] new ResultadoSQL()
                        \end{enumerate}               
                        \item[2.1.2] next()
                        \item[2.1.3] getInt(id\_copia): int
                    \end{enumerate}
                    \item[2.2] guardarPrestamo(id\_user, laCopia)
                    \begin{enumerate}
                        \item[2.2.1] execSQL(INSERT INTO Tomar\_prestamo (fecha\_prestamo, id\_user, id\_copia) VALUES (\%fecha\%,\%id\_user\%, \%laCopia\%))
                        \item[2.2.2] execSQL(UPDATE CopiaLibro SET Libre=0 WHERE id\_copia=\%laCopia\%)   
                    \end{enumerate} 
                \end{enumerate}
            \end{enumerate}            
            \clearpage
        ...
        \section{Administrador}
            ...
            \begin{figure}[H]
                ...
                \caption{Diagrama de comunicación para Foro}
            \end{figure}
            \begin{verbatim}
                JSON_Hilo{
                    [
            ...
            \begin{enumerate}
                ...
                \begin{enumerate}
                    ...
                    \begin{enumerate}
                        \item [3.1.1] execSQL(INSERT INTO Hilo (id\_user,titulo) VALUES(\%user\_id\%,\%titulo\%))
                    \end{enumerate}
                    \item [3.2] mostrarRespuesta(id\_hilo):JSON\_Respuesta
                    \item [3.3] responderHilo(user\_id,mensaje,hilo\_id)
                    \begin{enumerate}
                        \item [3.3.1] execSQL(INSERT INTO Responder\_Hilo (id\_user,respuesta,id\_hilo) VALUES (\%user\_id\%,\%mensaje\%,\%hilo\_id\%))
                    \end{enumerate}
                \end{enumerate}
            \end{enumerate}
            \clearpage
        \section{Recomendaciones del sistema}
            ...
            \clearpage
            \begin{enumerate}
                \item[1] El usuario selecciona el catálogo en el menú principal.
                \item[2] new Figura\_3.2.6.1(user\_id).
                \item[3] getRecomendacionesUser(user\_id):JSON\_Libros
                \begin{enumerate}
                    \item[3.1] listaLibros=getUserPrestamos(user\_id):JSON\_Libros
                    \begin{enumerate}
                        \item[3.1.1] execSQL(''
                        SELECT Libro.* 
                        FROM Tomar\_prestamo
                        ...
                        WHERE Tomar\_prestamo.id\_user = \%user\_id\%;
                        ''): new ResultadoSQL()
                        \begin{enumerate}
                            \item[3.1.1.1] new ResultadoSQL()
                        \end{enumerate}
                        ...
                        \item[3.1.4] getString('nombre'):String
                    \end{enumerate}
                    \item[3.2] listaAmigos=getFriends(user\_id):JSON\_Usuarios
                    \begin{enumerate}
                        \item[3.2.1] execSQL(''
                        SELECT U1.id\_user AS id\_amigo, U1.nombre AS nombre\_amigo
                        FROM User AS U
                        JOIN Amistad AS A ON U.id\_user = A.id\_user1 OR U.id\_user = A.id\_user2
                        JOIN User AS U1 ON (U.id\_user = A.id\_user1 AND U1.id\_user = A.id\_user2) OR (U.id\_user = A.id\_user2 AND U1.id\_user = A.id\_user1)
                        WHERE U.id\_user = \%user\_id\%;
                        ''): new ResultadoSQL()
                        \begin{enumerate}
                            \item[3.2.1.1] new ResultadoSQL()
                        \end{enumerate}
                        \item[3.2.2] next()
                        \item[3.2.3] getInt('id\_amigo'):int
                    \end{enumerate}
                    \item[3.3] listaLibros+=getUserPrestamos(listaAmigos):JSON\_Libros
                    \begin{enumerate}
                        \item[3.3.1] execSQL(''
                        SELECT Libro.* 
                        FROM Tomar\_prestamo
                    ...
                    \end{enumerate}
                    \item[3.4] getRecomendaciones(listaLibros):JSON\_Libros
                    \begin{enumerate}
                        \item[3.4.1] execSQL(''
                        SELECT Libro.*
                        FROM Libro
                        ...
                        ''): new ResultadoSQL()
                        \begin{enumerate}
                            \item[3.4.1.1] new ResultadoSQL()
                        \end{enumerate}
                        \item[3.4.2] next()
                        \item[3.4.3] getInt('id\_libro'):int
                        \item[3.4.4] getString('nombre'):String
                    \end{enumerate}
                \end{enumerate}
            \end{enumerate}                   
            \clearpage
        \section{Recomendaciones de amigos}
            ...
            \clearpage
            \begin{enumerate}
                \item El usuario selecciona el perfil en el menú principal.
                \item new UI\_PERFIL(user\_id).
                \item getRecomendacionesAmigos(user\_id):JSON\_Usuarios
                \begin{enumerate}
                    \item[3.1] listaLibros=getLibros():JSON\_Libros
                    \begin{enumerate}
                        \item[3.1.1] execSQL(''
                            SELECT Libro.* 
                            FROM User 
                        ...
                        \item[3.1.4] getString('nombre'):String
                    \end{enumerate}
                    \item[3.2] listaUsuarios=getFriendsFriends(user\_id):JSON\_Usuarios
                    \begin{enumerate}
                        \item[3.2.1] execSQL(''
                        SELECT DISTINCT a2.usuario2 AS amigodeamigo
                        FROM amigos a1 JOIN amigos a2 ON a1.usuario2 = a2.usuario1 WHERE a1.usuario1 = a1.id\_user AND a2.usuario2 = '\%user\_id\%';
                        \begin{enumerate}
                            \item[3.2.1.1] new ResultadoSQL()
                        \end{enumerate}
                        \item[3.2.2] next()
                        \item[3.2.3] getInt('user\_id'):int
                        \item[3.2.4] getString('nombre'):String
                    \end{enumerate}
                    \item[3.3] getAmigosPorRecomendaciones(listaLibros):JSON\_Usuarios
                    \begin{enumerate}
                        \item[3.3.1] execSQL(''
                            SELECT DISTINCT a2.usuario2 AS amigodeamigo, l.id\_libro
                            FROM amigos a1
                            JOIN amigos a2 ON a1.usuario2 = a2.usuario1
                            JOIN lecturas l ON a2.usuario2 = l.user\_id
                            WHERE a1.usuario1 = 'user\_id' AND a2.usuario2 = 'user\_id');
                            ''): ResultadoSQL
                        \begin{enumerate}
                            \item[3.3.1.1] new ResultadoSQL()
                        \end{enumerate}
                        \item[3.3.2] next()
                        \item[3.3.3] getInt('user\_id'):int
                        \item[3.3.4] getString('nombre'):String
                    \end{enumerate}
                \end{enumerate}
            \end{enumerate}
    \chapter{Diagrama de secuencias}
        \section{Gestión de reservas}
            \textbf{Mohamed El Basri}
            \begin{figure}[H]
                \centering
                \includegraphics[width=1.0\textwidth]{img/secuencia/secuenciamoha.png}
                \caption{Diagrama de secuencia de la gestion de reservas}
            \end{figure}
            \clearpage
        \section{Reseñas}
            \textbf{Javier Criado Garcia}
        ...
        \section{Red de amigos}
            ...
            \begin{figure}[H]
                \centering
                \includegraphics[width=1.0\textwidth]{img/secuencia/secuenciajon.png}
                \caption{Diagrama de secuencia de la red de amigos}
            \end{figure}
            \clearpage
        \section{Administrador}
            \textbf{Janire Veganzones García}
            \begin{figure}[H]
                \centering
                \includegraphics[width=1.0\textwidth]{img/secuencia/ObtenerAdmin.jpg}
                \caption{Diagrama de secuencia de Administracion general}
            \end{figure}
            \clearpage
            \begin{figure}[H]
                \centering
                \includegraphics[width=1.0\textwidth]{img/secuencia/CrearUsuario.jpg}
                \caption{Diagrama de secuencia de Crear Usuario}
            \end{figure}
            \clearpage
            \begin{figure}[H]
                \centering
                \includegraphics[width=1.0\textwidth]{img/secuencia/borrarUsuario.jpg}
                \caption{Diagrama de secuencia de Borrar Usuario}
            \end{figure}
            \clearpage
            \begin{figure}[H]
                \centering
                \includegraphics[width=1.0\textwidth]{img/secuencia/CrearLibro.jpg}
                \caption{Diagrama de secuencia de Añadir Libro}
            \end{figure}
            \clearpage
             \begin{figure}[H]
                \centering
                \includegraphics[width=1.0\textwidth]{img/secuencia/borrarLibro.jpg}
                \caption{Diagrama de secuencia de Borrar Libro}
            \end{figure}
            \clearpage
        \section{Foros}
            \textbf{Ainhize Martinez Duran}
        ...
        \section{Recomendaciones del sistema}
            ...
            \begin{figure}[H]
                \centering
                \includegraphics[width=1.0\textwidth]{img/secuencia/recomendacionesDelSistema.png}
                \caption{Diagrama de secuencia de las recomendaciones del sistema}
            \end{figure}
            \clearpage
        \section{Recomendaciones de amigos}
            \textbf{Kepa Reche Urrutia}
            \begin{figure}[H]
                \centering
                \includegraphics[width=1.0\textwidth]{img/secuencia/DSRecomendacionesAmigos.jpg}
                \caption{Diagrama de secuencia de las Recomendaciones de amigos}
            \end{figure}
            \clearpage
    \chapter{Problemas de implementación}
        \section{Gestión de reservas}
        \section{Reseñas}
        \section{Red de amigos}
        \section{Administrador}
             \textbf{Janire Veganzones Garcia}\\
            A la hora de programar el caso de uso de administrador he tenido varios problemas. El que mass tiempo me ha llevado ha sido el de mostrar las alertas, no me las mostraba entonces he tenido que crear una clase html de mensaje para que saliese un mensaje, otro error que he tenido ha sido a la hora de crear la bd ya que la he tenido que cambiar para crear mas campos y por ultimo a la hora de tener que fusionar las ramas con mis compañeros me dio un problema y estuvimos varias horas intentando fusionarlo.\\
        ...
        \section{Recomendaciones del sistema}
            \textbf{Xabier Gabiña Barañano}\\
            Principalmente los problemas y limitaciones vienen dada del hecho de que varios integrantes del grupo han abandonado el proyecto haciendo que funciones como el tomar prestamos o añadir amigos no esten implementadas por lo que han tenido que se hechas "hardcodeadas" en la base de datos.\\
            Esto ha realentizado sobre todo la parte de las pruebas unitarias ya que no se podian realizar pruebas de las funciones que no estaban implementadas.\\
        ...
        \section{Recomendaciones de amigos}
            ...
            A la hora de crear amistades por ejemplo el User1 era amigo del User2 y eso deberia servir para que el User2 tambien fuese del User1, pero no era asi. 
            Del problema anterior, derivaba el de la obtencion de los amigos de tus amigos, intentaba obtenerlos utilizando una unica Select pero no conseguia el resultado esperado.
            La solucion que encontré era un poco liosa ya que habia estructuras con tuplas anidadas y resultaba tedioso seguir el orden.
            Una vez conseguido el resultado, no sabia muy bien como enviar el resultado al HTML y mostrarlo de forma atractiva visualmente.\\
            Con la ayuda de mis compañeros Xabi y Janire y consultando información en foros y herramientas como Copilot he conseguido resolver todos los problemas mencionados.\\
    ...
    \chapter{Repositorio}
        \huge\center\href{https://github.com/Xabierland/ADSI-Proyecto}{Link al repositorio}
