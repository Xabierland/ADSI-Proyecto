...
\begin{document}
    ...
    \chapter{Diagramas de comunicación}
        ...
        \section{Administrador}
            ...
            \begin{figure}[H]
                \centering
                %\includegraphics[width=1.0\textwidth]{img/comunicacion/administrador.png}
                \caption{Diagrama de comunicación del administrador}
            \end{figure}
            \clearpage
        \section{Foros}
        ...
        \section{Recomendaciones del sistema}
            ...
            \clearpage
            \begin{enumerate}
                \item \texttt{El usuario selecciona el catálogo en el menú principal.}
                \item \texttt{new UI\_CATALOGO(user\_id)}.
                \item \texttt{getRecomendacionesUser(user\_id):JSON\_Libros}
                \begin{enumerate}
                    \item[3.1] \texttt{listaLibros=getUserData(user\_id):JSON\_Libros}
                    \begin{enumerate}
                        \item[3.1.1] \texttt{execSQL("
                            SELECT Libro.* 
                            FROM User 
                            ...
                            "): ResultadoSQL}
                        \begin{enumerate}
                            \item[3.1.1.1] \texttt{new ResultadoSQL()}
                        \end{enumerate}
                        \item[3.1.2] \texttt{next()}
                        \item[3.1.3] \texttt{getInt("id\_libro"):int}
                        \item[3.1.4] \texttt{getString("nombre"):String}
                    \end{enumerate}
                    \item[3.2] \texttt{listaLibros=getFriendsData(user\_id):JSON\_Libros}
                    \begin{enumerate}
                        \item[3.2.1] \texttt{execSQL("
                            SELECT Libro.* 
                            FROM User 
                            ...
                            "): ResultadoSQL}
                        \begin{enumerate}
                            \item[3.2.1.1] \texttt{new ResultadoSQL()}
                        \end{enumerate}
                        \item[3.2.2] \texttt{next()}
                        \item[3.2.3] \texttt{getInt(\"id\_libro"):int}
                        \item[3.2.4] \texttt{getString("nombre"):String}
                    \end{enumerate}
                    \item[3.3] \texttt{getRecomendaciones(listaLibros):JSON\_Libros}
                    \begin{enumerate}
                        \item[3.3.1] \texttt{execSQL("
                            SELECT Libro.*
                            FROM Libro
                            ...
                            "): ResultadoSQL}
                        \begin{enumerate}
                            \item[3.3.1.1] \texttt{new ResultadoSQL()}
                        \end{enumerate}
                        \item[3.3.2] \texttt{next()}
                        \item[3.3.3] \texttt{getInt(\"id\_libro"):int}
                        \item[3.3.4] \texttt{getString("nombre"):String}
                    \end{enumerate}
                \end{enumerate}
            \end{enumerate}
            \clearpage
