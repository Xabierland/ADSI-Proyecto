                ...
                \begin{center}
                    \begin{longtable}{|p{\linewidth}|}
                        ...
                        \begin{enumerate}
                            ...
                            \begin{enumerate}
                                \item Se accede a la interfaz de añadir libro.
                                \item[] [Si el libro introducido ya esta en la página]
                                \begin{enumerate}
                                    \item Aparecerá un mensaje que lo indica.
                                \end{enumerate}
                                \item[] [Si el usuario pulsa en borrar]
                                \item Se accede a la interfaz de eliminar un libro.
                                \item[] [Si el libro no existe]
                                \begin{enumerate}
                                    \item Aparecerá un mensaje que lo indica.
                                \end{enumerate}
                                \item[] [Si el usuario pulsa en modificar]
                                \item Se accede a la interfaz de modificar libro.
                                \item[] [Si alguno de los campos introducidos es incorrecto]
                                \begin{enumerate}
                                    \item Aparecerá un mensaje que lo indica.
                                \end{enumerate}
                ...
                \begin{center}
                    \begin{longtable}{|p{\linewidth}|}
                        ...
                        \begin{enumerate}
                            ...
                            \begin{enumerate}
                                ...
                                \begin{enumerate}
                                    ...
                                    \begin{enumerate}
                                        \item Si el usuario pulsa en 'Responder' se le abre una ventana para responder al mensaje del hilo donde esta el boton.
                                        \item Si el usuario pulsa en 'Mensaje' se le abre una ventana para responder al hilo
                                    \end{enumerate}
                                \end{enumerate}
                            \end{enumerate}
                        \end{enumerate}\\
                        ...
                        \begin{figure}[H]
                            ...
                            \\Figura 3.2.5.4: Interfaz para responder a un hilo o mensaje del mismo.
                        \end{figure}\\
                        \hline
                    \end{longtable}
                \end{center}
