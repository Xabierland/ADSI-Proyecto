...
\begin{document}
    ...
    \chapter{Diagrama de secuencias}
        ...
        \section{Reseñas}
            ...
            \begin{figure}[H]
                \centering
                \includegraphics[width=1.0\textwidth]{img/secuencia/seleccionarLibro.jpg}
                \caption{Diagrama de secuencia de seleccion de libro}
            \end{figure}
            \clearpage
            \begin{figure}[H]
                \centering
                \includegraphics[width=1.0\textwidth]{img/secuencia/verReseñas.jpg}
                \caption{Diagrama de secuencia de visualizacion de reseñas}
            \end{figure}
            \clearpage
        \section{Red de amigos}
            \textbf{Jon Valdes Granado}
