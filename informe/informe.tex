    ...
    \chapter{Diagramas de comunicación}
        ...
        \section{Foros}
            ...
            \begin{figure}[H]
                ...
                \caption{Diagrama de comunicación para crear hilo}
            \end{figure}
            \begin{verbatim}
                JSON_Hilo{
                    [
            ...
            \begin{figure}[H]
                \centering
                \includegraphics[width=1.0\textwidth]{img/comunicacion/foros2.png}
                \caption{Diagrama de comunicación para ver y responder hilo}
            \end{figure}
            ...
            \begin{enumerate}
                ...
                \item getHilos(user\_id):JSON\_Hilo
                \begin{enumerate}
                    \item [3.1] mostrarRespuesta(id\_hilo):JSON\_Respuesta
                    \begin{enumerate}
                        \item [3.1.1] responderHilo(user\_id,mensaje,hilo\_id)
                        \begin{enumerate}
                            \item[3.1.1.1] execSQL(INSERT INTO Responder\_Hilo (id\_user,respuesta,id\_hilo) VALUES (\%user\_id\%,\%mensaje\%,\%hilo\_id\%))
                        \end{enumerate}
                    \end{enumerate}
                \end{enumerate}
            \end{enumerate}
            ...
            \begin{enumerate}
                ...
                \begin{enumerate}
                    ...
                    \begin{enumerate}
                        ...
                        \end{enumerate}
                        \item[3.2.2] next()
                        \item[3.2.3] getInt('id\_user'):int
                    \end{enumerate}
